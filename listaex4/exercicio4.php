...
<div class="mb-3">
              ...
              <input type="int" id="dia" name="dia" class="form-control" required="">
              <label for="mes" class="form-label">Insira o mês:</label>
              <input type="int" id="mes" name="mes" class="form-control" required="">
              <label for="ano" class="form-label">Insira o ano:</label>
              <input type="int" id="ano" name="ano" class="form-control" required="">
            </div>
